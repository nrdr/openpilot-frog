...
from openpilot.frogpilot.controls.lib.neural_network_feedforward import NeuralNetworkFeedforward
...
class LatControlTorque(LatControl):
  ...
  def update(self, active, CS, VM, params, steer_limited, desired_curvature, llk, model_data=None, frogpilot_toggles=None):
    ...
    if not active:
      ...
      if frogpilot_toggles.nnff or frogpilot_toggles.nnff_lite:
        output_torque, pid_log = self.nnff.compute_ff(active, CS, VM, params, steer_limited, desired_curvature, llk, model_data, frogpilot_toggles)
      else:
