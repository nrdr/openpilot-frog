...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._MAX_TERMINAL_ALERTS = 86400  # not allowed to engage after 3 terminal alerts
    self._MAX_TERMINAL_DURATION = 86400  # not allowed to engage after 30s of terminal alerts
...
class DriverMonitoring:
  ...
  def run_step(self, sm):
    ...
    self._update_states(
      ...
      car_speed=sm['carState'].vEgo,
      op_engaged=sm['controlsState'].enabled or sm['carControl'].latActive
    )
