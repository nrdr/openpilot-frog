  ...
  return html`
    <div class="screen-recordings-wrapper">
      <div class="screen-recordings-widget">
        ...
        ${() => {
          return html`
            ${(state.loading && state.total > 0) ? html`<p class="screen-recordings-message">Processing Recordings: ${state.progress} of ${state.total}</p>` : ''}
            ${(state.loading && state.recordings.length === 0) ? html`<p class="screen-recordings-message">Loading…</p>` : ''}
            ${(state.error && state.recordings.length === 0) ? html`<p class="screen-recordings-message">${state.error}</p>` : ''}
            ${(!state.loading && state.recordings.length === 0) ? html`<p class="screen-recordings-message">No screen recordings found.</p>` : ''}
